      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 && (
          <div className="text-center text-muted-foreground text-sm mt-8">
            <p className="mb-2 font-semibold">🎬 God-Tier AI Director & Engineer</p>
            <p className="text-xs">Veo 3.1-level capabilities:</p>
            <ul className="text-xs mt-2 space-y-1 text-left max-w-xs mx-auto">
              <li>🔍 <strong>Diagnose</strong> - Analyze production issues</li>
              <li>🔧 <strong>Fix</strong> - Repair code & video bugs</li>
              <li>🎬 <strong>Direct</strong> - Reality TV-level scene direction</li>
              <li>🎥 <strong>Generate</strong> - Create video manifests & scripts</li>
              <li>🎯 <strong>Orchestrate</strong> - Coordinate full production</li>
              <li>⚡ <strong>Engineer</strong> - World-class code solutions</li>
            </ul>
